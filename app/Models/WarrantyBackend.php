...
class WarrantyBackend extends Model
{
    use HasFactory;
    ...
    public function lines() : HasMany{
        return $this->hasMany(WarrantyBackendLine::class, 'returns_header_id', 'id');
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            $latestRef = WarrantyBackend::selectRaw('SUBSTR(return_reference_no, 1, 8) AS refno')
                ->orderByDesc('refno')
                ->first();
